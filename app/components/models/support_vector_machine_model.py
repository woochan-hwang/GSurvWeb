...
class SupportVectorClassifier(BaseModel):
    ...
    def __init__(self):
        ...
        self.iterable_model_options_dict = {
            'c_param':self.c_param, 'c_param_list':self.c_param_list,
            'kernel':self.kernel, 'kernel_list':self.kernel_list
           }
        self.option_widget_type_dict = {'kernel':'unordered', 'c_param':'ordered'}
